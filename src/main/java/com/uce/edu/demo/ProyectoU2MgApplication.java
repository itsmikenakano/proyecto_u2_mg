...
public class ProyectoU2MgApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		LOG.info("Persona NativeQuery: "+this.iPersonaJpaService.buscarPorCedulaNative("12345"));
		
		LOG.info("Persona NamedNativeQuery: "+this.iPersonaJpaService.buscarPorCedulaNamedNative("12345"));
